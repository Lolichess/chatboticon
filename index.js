...
chat.setAttribute("id", "chatbase-bubble-window"),
  ...
  (chat.innerHTML = `<iframe\nsrc="https://app.doc2chat.com/shared-bubble/chatbot/${scriptTag.id}"\nwidth="100%"\nheight="100%"\nframeborder="0"\n></iframe>`);
const mediaQuery = window.matchMedia("(min-width: 550px)");
function handleChatWindowSizeChange(t) {
  t.matches && ((chat.style.height = "465px"), (chat.style.width = "400px"));
}
